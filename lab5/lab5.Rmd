...
После удаления выбросов диета B стала лучше, чем диета А
...
plot(cld(tuk, level=.05),col="lightgrey")
```
Вывод: Получили, что потеря веса зависит от пола не существенно. Худеть тяжело как женскому , так и мужскому полу